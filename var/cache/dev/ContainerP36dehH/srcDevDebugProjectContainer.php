...
class srcDevDebugProjectContainer extends Container
{
    ...
    {
        $a = new \Twig\Loader\FilesystemLoader(array(), 'C:\\my_project_task');
        $a->addPath('C:\\my_project_task/templates');
        $a->addPath('C:\\my_project_task\\vendor\\symfony\\framework-bundle/Resources/views', 'Framework');
        $a->addPath('C:\\my_project_task\\vendor\\symfony\\framework-bundle/Resources/views', '!Framework');
        $a->addPath('C:\\my_project_task\\vendor\\symfony\\maker-bundle\\src/Resources/views', 'Maker');
        $a->addPath('C:\\my_project_task\\vendor\\symfony\\maker-bundle\\src/Resources/views', '!Maker');
        $a->addPath('C:\\my_project_task\\vendor\\symfony\\twig-bundle/Resources/views', 'Twig');
        $a->addPath('C:\\my_project_task\\vendor\\symfony\\twig-bundle/Resources/views', '!Twig');
        $a->addPath('C:\\my_project_task/templates');

        $this->services['twig'] = $instance = new \Twig\Environment($a, array('paths' => array('C:\\my_project_task/templates' => NULL), 'debug' => true, 'strict_variables' => true, 'exception_controller' => 'twig.controller.exception:showAction', 'form_themes' => $this->parameters['twig.form.resources'], 'autoescape' => 'name', 'cache' => ($this->targetDirs[0].'/twig'), 'charset' => 'UTF-8', 'default_path' => 'C:\\my_project_task/templates', 'date' => array('format' => 'F j, Y H:i', 'interval_format' => '%d days', 'timezone' => NULL), 'number_format' => array('decimals' => 0, 'decimal_point' => '.', 'thousands_separator' => ',')));
        ...
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\CodeExtension(($this->privates['debug.file_link_formatter'] ?? $this->privates['debug.file_link_formatter'] = new \Symfony\Component\HttpKernel\Debug\FileLinkFormatter(NULL)), 'C:\\my_project_task\\src', 'UTF-8'));
    ...
    {
        return $this->privates['cache.annotations'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('jnFI9vwH-v', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ($this->privates['logger'] ?? $this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger()));
    }
    ...
    {
        return $this->privates['router_listener'] = new \Symfony\Component\HttpKernel\EventListener\RouterListener(($this->services['router'] ?? $this->getRouterService()), ($this->services['request_stack'] ?? $this->services['request_stack'] = new \Symfony\Component\HttpFoundation\RequestStack()), ($this->privates['router.request_context'] ?? $this->getRouter_RequestContextService()), ($this->privates['logger'] ?? $this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger()), 'C:\\my_project_task', true);
    }
    ...
    {
        return array(
            'kernel.root_dir' => 'C:\\my_project_task\\src',
            'kernel.project_dir' => 'C:\\my_project_task',
            ...
            'kernel.bundles_metadata' => array(
                'FrameworkBundle' => array(
                    'path' => 'C:\\my_project_task\\vendor\\symfony\\framework-bundle',
                    'namespace' => 'Symfony\\Bundle\\FrameworkBundle',
                ),
                'WebServerBundle' => array(
                    'path' => 'C:\\my_project_task\\vendor\\symfony\\web-server-bundle',
                    'namespace' => 'Symfony\\Bundle\\WebServerBundle',
                ),
                'MakerBundle' => array(
                    'path' => 'C:\\my_project_task\\vendor\\symfony\\maker-bundle\\src',
                    'namespace' => 'Symfony\\Bundle\\MakerBundle',
                ),
                'SensioFrameworkExtraBundle' => array(
                    'path' => 'C:\\my_project_task\\vendor\\sensio\\framework-extra-bundle',
                    'namespace' => 'Sensio\\Bundle\\FrameworkExtraBundle',
                ),
                'TwigBundle' => array(
                    'path' => 'C:\\my_project_task\\vendor\\symfony\\twig-bundle',
            ...
            'twig.default_path' => 'C:\\my_project_task/templates',
